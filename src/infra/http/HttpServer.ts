...
export class ExpressHttpServer implements HttpServer {
	...
	public get(url: string, callback: GetCallback): void {
	...
	public post(url: string, callback: PostCallback): void {
	...
	public patch(url: string, callback: PatchCallback): void {
	...
	public delete(url: string, callback: DeleteCallback): void {
		this.app.patch(url, async function(req: Request, res: Response) {
			try {
